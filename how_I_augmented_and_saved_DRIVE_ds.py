...
#!rm -rf /content/drive/MyDrive/Colab/ds/train_data
#!rm -rf /content/drive/MyDrive/Colab/ds/valid_data
!pip install tqdm
...
!find . -type f -name '*.tif' ! -name '21_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '21_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '21_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '1_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '1_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '1_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
!cp /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/DRIVE/training/train_data/ /content/drive/MyDrive/Colab/ds/ -R
!cp /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/DRIVE/training/valid_data/ /content/drive/MyDrive/Colab/ds/ -R
%cd /content/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '22_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '22_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '22_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '2_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '2_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '2_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '23_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '23_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '23_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '3_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '3_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '3_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '24_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '24_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '24_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '4_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '4_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '4_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '25_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '25_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '25_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '5_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '5_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '5_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '26_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '26_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '26_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '6_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '6_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '6_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '27_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '27_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '27_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '7_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '7_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '7_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '28_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '28_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '28_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '8_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '8_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '8_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '29_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '29_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '29_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '9_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '9_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '9_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '30_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '30_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '30_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '10_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '10_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '10_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '31_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '31_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '31_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '11_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '11_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '11_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '32_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '32_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '32_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '12_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '12_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '12_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '33_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '33_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '33_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '13_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '13_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '13_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '34_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '34_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '34_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '14_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '14_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '14_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '35_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '35_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '35_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '15_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '15_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '15_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '36_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '36_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '36_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '16_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '16_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '16_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '37_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '37_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '37_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '17_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '17_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '17_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '39_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '39_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '39_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '19_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '19_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '19_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
...
%cd DRIVE/training/images/
!find . -type f -name '*.tif' ! -name '40_training.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/1st_manual/
!find . -type f -name '*.gif' ! -name '40_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/training/mask/
!find . -type f -name '*.gif' ! -name '40_training_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/

%cd DRIVE/test/images/
!find . -type f -name '*.tif' ! -name '20_test.tif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/1st_manual/
!find . -type f -name '*.gif' ! -name '20_manual1.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
%cd DRIVE/test/mask/
!find . -type f -name '*.gif' ! -name '20_test_mask.gif' -exec rm -f {} +
%cd /content/Retinal-Vessel-Segmentation_A-Computer-Vision-Technique/
